  ...
  return (
    <nav className="w-screen bg-gray-300 grid grid-flow-row">
      <div className="flex items-center justify-center w-full my-2 gap-5">
        <div>
          <button
            className={`border border-teal-100 shadow-md py-2 px-5 
                transition-all active:scale-95 ${settings.algoType === "merge sort" && "text-purple-500"}`}
          ...
          <button
            className={`border border-teal-100 shadow-md py-2 px-5 
                transition-all active:scale-95 ${settings.algoType === "insertion sort" && "text-purple-500"}`}
